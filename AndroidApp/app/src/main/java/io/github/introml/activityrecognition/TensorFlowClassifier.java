...
public class TensorFlowClassifier {
    ...
    public float[] predictProbabilities(float[] data) {
        ...
        inferenceInterface.feed(INPUT_NODE, data, INPUT_SIZE); //feeding inputs to the model
        inferenceInterface.run(OUTPUT_NODES); //running the model
        inferenceInterface.fetch(OUTPUT_NODE, result); //fetching the output
